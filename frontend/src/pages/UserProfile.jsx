...
const UserProfile = () => {
  ...
  // 🔢 Stats koneksi untuk user yang sedang dilihat
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      // fallback ke getAllUsers kalau endpoint getUserById gagal
      try {
  ...
  const fetchUserStats = async (targetUserId) => {
    try {
      ...
      setStats({
        totalConnections: Number(apiStats.total_connections || 0)
      });
    } catch (error) {
